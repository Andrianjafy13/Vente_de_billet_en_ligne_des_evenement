    ...
    <div class="row">
         <% for( AjoutModele ajoutM : listRecherche) {%>
                        ...
                        <div class="gallery" >
                            ...
                            <img src="image/<% out.println(ajoutM.getImg()); %>" alt="Cinque Terre" width="200" height="400">
                          <div class="card-body">
                            <!--<div class="desc">-->
                                ...
                                <li>Paf  :   <% out.println(ajoutM.getPaf()); %>  Ariary</li>
                                  ...
                                  <a class="btn btn-secondary" href="detaile.jsp?id=<% out.println(ajoutM.getId()); %>" style="margin-left: 100px;">Voire detaile</a>
                            <!--</div>-->
