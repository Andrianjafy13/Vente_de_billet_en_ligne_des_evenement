<%-- 
    Document   : annonce
    Created on : 26 févr. 2024, 18:52:07
    Author     : USER
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="bootstrap.min.css">
         <link rel="stylsheet" href="css/annonce.css">
        <title>Annonce et publication de festivale</title>
    </head>
    <style>
                    ...
                    <div class="row g-3">
                            <div class="col-12">
                                ...
                                <select class="form-select" id="country" name="titre">
                                    <option class="telma" value="Assembler_Nationnal">Assembler Nationnal</option>
                                    <option class="airtel" value="Evènements_d_entreprise ">Les évènements d’entreprise </option>
                                    <option class="orange" value="Evènements_Sociaux">Les évènements sociaux</option>
