 ...
 %>
        ...
        <link rel="stylesheet" type="text/css" href="css/smoothness/jquery-ui-1.8.17.custom.css">
         ...
         <script>
                ...
                function demoTwoPageDocument() {
                    var doc = new jsPDF();
                    alert("Telecharger le billlet");
                    var p1 = document.getElementById("firstNames").value;
                    var p2 = document.getElementById("lastName").value;
                    var p3 = document.getElementById("email").value;
                    var p4 = document.getElementById("emails").value;
                    var p5 = document.getElementById("evenement").value;
                    var p6 = document.getElementById("country").value;
                    
                    doc.text(20, 10, "Billet d'événement");
                    doc.text(20, 20,p1);
                    doc.text(20, 30,p2);
                    doc.text(20, 40,p3);
                    doc.text(20, 50,p4);
    ...
    <body>
  	...
  	<div class="container">
            ...
            <div>    
                  <h2>Nombre de place disponible : <%out.println(event.getNombre());
            ...
            <div class=" row g-3">
                ...
                <div class="col-sm-6">
                    ...
                    <input class="form-control" id="firstNames" type="text" name="nom">
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                 ...
                 <div class="col-12">
                    <label for="email" class="form-label">Nombre du billet :</label>
               ...
               <select class="form-select" id="country" name="payment">
                   <option class="telma" value="MVola">MVola (Envoier à 034123411 )</option>
                ...
                <div class="col-12">
                        ...
                        <input type="file" id="img" name="capture" placeholder="ajouter un image" accept="image/*">
                </div>
                <div class="col-md-5">
                ...
                <div class="bouton">
                    <button type="submit" class="ajouter" onclick="demoTwoPageDocument()">Acheter</button>
