<%-- 
    Document   : assembler_Generale
    Created on : 15 févr. 2024, 03:45:16
    Author     : USER
--%>
...
<%
   AnnonceDao list = new AnnonceDao();
    List<AnnonceModele> listeEvent = new ArrayList<AnnonceModele>();
...
#btn1 {
    ...
    <body>
    <div class="text">
        <h1 class="historique">ASSEMBLER GENERALE</h1>
    ...
    <div class="contenaire swiper">
        ...
        <div class="slide-content">
            ...
            <div class="cadre-image swiper-wrapper">
                <% for( AnnonceModele ajoutM : listeEvent) {%>
    ...
    <div class="retour1">
        <a href="accuiel.jsp" class="lien1" id="btn1" style="text-decoration: none;">Retour</a>
            <!--<a href="ajoutAssembler.jsp" class="lien" style="text-decoration: none;">Ajout d'assembler </a>-->        
    </div>
