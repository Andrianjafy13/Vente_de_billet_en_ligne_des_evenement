    ...
    <div class="wrapper">
        <div class="form-wrapper sign-in">
            <form action="ConnectServlet" method="POST">
                ...
                <button type="submit" style="border-radius: 30px; color: white; background-color: black; font-size: 25px;">Se connecter</button>
            ...
            <form action="formulairServlet" method="POST">
                <h2>Inscription</h2>
                   ...
                   <!-- <div class="remember">
                    ...
                    <button type="submit" style="border-radius: 30px;color: white; background-color: black; font-size: 25px;">S'inscrire</button>
                    <div class="signUp-link">
